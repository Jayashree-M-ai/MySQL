...
select employees.emp_name, employees.salary from employees 
...
select sum(amount) as total_sales from sales where sale_date='2023-03-17';

-- Question 5: High-Value Orders Get the names of customers who have placed an order of more than 600.
select customer_name, order_amount from orders where order_amount>600;
